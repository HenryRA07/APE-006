...
public class Main {
    public static void printMenu(){
        ...
        System.out.println("2. Serie de primos elevados al cubo  hasta un limite (S = 2^3 + 3^3 + 5^3 + 7^3 + 11^3 + 13^3 ... + N^3): ");
        System.out.println("3. Serie de primos elevados al cubo  hasta N términos (S = 2^3 + 3^3 + 5^3 + 7^3 + 11^3 + 13^3 ...): ");
        System.out.println("4. Serie de primos elevados por pares hasta un limite (S = 2^2 + 3^4 + 5^6 + 7^8 + 11^10 + 13^(12) ... + N): ");
        System.out.println("5. Serie de primos elevados a impares hasta n térmimos (S = 2^1 + 3^3 + 5^5 + 7^7 + 11^9 + 13^11 ...): ");
        System.out.println("6. Serie de primos elevados a la raiz de numeros pares hasta un limite (S = 2^(1/2) + 3^(1/4) + 5^(1/6) + 7^(1/8) + 11^(1/10) + 13^(1/12) ... + N): ");
        ...
        System.out.println("8. Serie de primos elevados a la raiz cúbica hasta un n términos (S = 2^(1/3) + 3^(1/3) + 5^(1/3) + 7^(1/3) + 11^(1/3) + 13^(1/3)): ");
        System.out.println("9. Serie de primos elevados a la raiz cuadrada hasta un limite (S = 2^(1/2) + 3^(1/2) + 5^(1/2) + 7^(1/2) + 11^(1/2) + 13^(1/2)+ .. + N^(1/2): ");
        System.out.println("10. Serie de primos hasta un limite (S = 2 + 3 + 5 + 7 + 11 + 13 + .. + N: ");
